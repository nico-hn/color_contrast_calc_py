...
class TestLightness(unittest.TestCase):
    ...
    def test_find(self):
        ...
        new_rgb = lightness.find(fuchsia, azure, 'A')
        ...
        new_rgb = lightness.find(darkgreen, darkgreen, 'A')
        new_color = Color(new_rgb)
        ...
        new_rgb = lightness.find(white, orange, 'AA')
        new_color = Color(new_rgb)
        ...
        new_rgb = lightness.find(white, green, 'AA')
        new_color = Color(new_rgb)
        new_contrast_ratio = new_color.contrast_ratio_against(white)
        ...
        new_rgb = lightness.find(blueviolet, orange, 'AA')
        new_color = Color(new_rgb)
        ...
        new_rgb = lightness.find(springgreen, springgreen, 'AA')
        new_color = Color(new_rgb)
        ...
        new_rgb = lightness.find(orange, yellow)
        new_color = Color(new_rgb)
        self.assertTrue(new_color.is_same_color(white))
        self.assertLess(new_color.contrast_ratio_against(yellow), 4.5)

        new_rgb = lightness.find(yellow, mintcream)
        new_color = Color(new_rgb)
        self.assertTrue(new_color.is_same_color(white))
        self.assertLess(new_color.contrast_ratio_against(yellow), 4.5)

        new_rgb = lightness.find(white, orange, 'AAA')
        new_color = Color(new_rgb)
        new_contrast_ratio = new_color.contrast_ratio_against(white)
        ...
        new_rgb = lightness.find(white, green, 'AAA')
        new_color = Color(new_rgb)
        new_contrast_ratio = new_color.contrast_ratio_against(white)
        ...
        new_rgb = lightness.find(green, blue, 'AAA')
        new_color = Color(new_rgb)
